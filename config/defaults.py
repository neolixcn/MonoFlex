...
_C.INPUT.HEIGHT_TRAIN = 704#384
# Maximum size of the side of the image during training
_C.INPUT.WIDTH_TRAIN = 1280
# Size of the smallest side of the image during testing
_C.INPUT.HEIGHT_TEST = 704#384
...
_C.MODEL.BACKBONE.CONV_BODY = "dla34"#"hg"#"dla34"#
...
# # since only car and pedestrian have enough samples and are evaluated in KITTI server 
# _C.MODEL.HEAD.DIMENSION_STD = ((0.45442242, 0.43771471, 0.29804158),
